...
function assign(){
    ...
    $firstPlayerSuit.css("diplay", "block");
    $secondPlayerSuit.css("diplay", "block");
    ...
    if (suit1 == 3) {
        suit1 = "<img src='./images/clubs.jpeg'/>"
    }
    if (suit1 == 4) {
        suit1 = "<img src='./images/spades.jpeg'/>"
    }
    if (suit2 == 1) {
    ...
    if (suit2 == 3) {
        suit2 = "<img src='./images/clubs.jpeg'/>"
    }
    if (suit2 == 4) {
        suit2 = "<img src='./images/spades.jpeg'/>"
    }
    ...
    if (number1<11){
        ...
        if (number1 == 11) {
            numberImg1 = "<img src='./images/jack.webp'/>"
            $firstPlayerSuit.append(suit1);
            $firstPlayerNumber.html(numberImg1);
        }
        if (number1 == 12) {
            numberImg1 = "<img src='./images/queen.jpeg'/>"
            $firstPlayerSuit.append(suit1);
            $firstPlayerNumber.html(numberImg1);
        }
        if (number1 == 13) {
    ...
    if (number2<11){
        ...
        if (number2 == 11) {
            numberImg2 = "<img src='./images/jack.webp'/>"
            $secondPlayerSuit.append(suit2);
            $secondPlayerNumber.html(numberImg2);
        }
        if (number2 == 12) {
            numberImg2 = "<img src='./images/queen.jpeg'/>"
            $secondPlayerSuit.append(suit2);
            $secondPlayerNumber.html(numberImg2);
        }
        if (number2 == 13) {
...
function war() {
    ...
    for (i=0; i<3; i++){
        ...
        numberImg1 = "<img style='height:14rem;' src='./images/BackOfCard.png'/>";
        $firstPlayerNumber.html(numberImg1);
        numberImg2 = "<img style='height:14rem;' src='./images/BackOfCard.png'/>";
        $secondPlayerNumber.html(numberImg2);
...
function greater(){
    ...
    console.log("in greater how many played ", playedCards.length)
        if (number1 > number2){
            ...
            $player2Count.html(secondPlayerPlayer.length);
            playedCards=[]
